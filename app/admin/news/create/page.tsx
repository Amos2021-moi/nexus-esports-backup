...
export default function CreateNewsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(formData.published ? "News published successfully!" : "News saved as draft!")
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">Write and publish news for the community</p>
        </div>
      </div>
