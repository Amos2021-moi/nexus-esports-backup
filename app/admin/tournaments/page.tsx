...
import { motion, AnimatePresence, type Variants } from "framer-motion"; // ✅ CHANGED
import {
  Trophy,
  Plus,
  Calendar,
...
function DecorBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-900 to-indigo-950">
      <div className="absolute -left-32 top-0 h-96 w-96 rounded-full bg-amber-500/20 blur-[120px]" />
      <div className="absolute right-0 top-1/3 h-96 w-96 rounded-full bg-yellow-500/10 blur-[120px]" />
      ...
      <>
        ...
        <div className="flex h-64 items-center justify-center">
          <div className="text-center">
            <div className="mx-auto mb-3 h-12 w-12 animate-spin rounded-full border-[3px] border-amber-500 border-t-transparent" />
        ...
        <motion.div variants={containerVariants} className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {stats.map((stat) => (
            <motion.div
              ...
              className={`group relative min-h-[44px] overflow-hidden rounded-2xl border bg-gray-800/40 p-4 shadow-xl backdrop-blur-xl transition-colors hover:border-amber-500/40 ${stat.ring}`}
            >
              <div
            ...
            {filteredTournaments.map((tournament) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gray-800/40 p-4 shadow-xl backdrop-blur-xl transition-colors hover:border-amber-500/40 sm:p-5"
                >
                  <div className="pointer-events-none absolute -right-12 -top-12 h-28 w-28 rounded-full bg-amber-500/10 blur-3xl transition-opacity group-hover:opacity-100" />
            ...
            >
              ...
              >
                <div className="mb-4 flex items-center justify-between gap-3">
                  <h2 className="text-lg font-semibold text-white sm:text-xl">Create Tournament</h2>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                    <button
                      type="submit"
                      disabled={submitting}
                      className="flex min-h-[44px] flex-1 items-center justify-center rounded-xl bg-gradient-to-r from-amber-600 to-yellow-600 py-2 font-semibold text-white transition-all hover:from-amber-700 hover:to-yellow-700 disabled:opacity-50"
                    >
