...
export default function NotificationCenterPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters */}
      <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-white/10 bg-gray-800/40 p-4 shadow-2xl backdrop-blur-xl">
            ...
            >
              ...
              {btn.count > 0 && (
                <span className={`rounded-full px-1.5 py-0.5 text-[10px] ${
                  filter === btn.value ? "bg-white/20" : "bg-white/5"
                }`}>
                  {btn.count}
                </span>
              )}
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-3 text-xs">
                      <span className={`flex items-center gap-1 font-medium ${config.color}`}>
                        ...
                        {config.label} • {notif.priority}% priority
                      </span>
                      {notif.reason && (
