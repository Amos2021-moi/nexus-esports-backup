...
import { Save, Loader2, Palette, Sun, Moon, Monitor, Layout, Eye, EyeOff } from "lucide-react"
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              type="button"
              onClick={() => setSettings({ ...settings, sidebarStyle: "default" })}
              className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${
            ...
            <button
              type="button"
              onClick={() => setSettings({ ...settings, sidebarStyle: "compact" })}
              className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${
            ...
            <button
              type="button"
              onClick={() => setSettings({ ...settings, sidebarStyle: "icon" })}
              className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${
